...
import { Shield, FileText, Cookie, CheckCircle2 } from 'lucide-react';
...
export const LegalPages: React.FC<{ initialTab?: 'privacy' | 'terms' | 'cookies' }> = ({ initialTab = 'privacy' }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 space-y-10">
      ...
      {/* Content */}
      <div className="bg-white p-8 sm:p-10 rounded-3xl border border-stone-200 shadow-soft text-xs text-stone-600 space-y-6 leading-relaxed">
        ...
        {activeTab === 'privacy' && (
          <div className="space-y-4">
            ...
            <h3 className="font-bold text-sm text-stone-800 pt-2">1. Data Ownership & Protection</h3>
            <p>
            ...
            <h3 className="font-bold text-sm text-stone-800 pt-2">2. Protection of Living Individuals</h3>
            <p>
            ...
            <h3 className="font-bold text-sm text-stone-800 pt-2">3. Storage & Encryption</h3>
            <p>
        ...
        {activeTab === 'terms' && (
          <div className="space-y-4">
            <h2 className="font-serif text-2xl font-bold text-stone-900">Terms of Service</h2>
            <p className="text-stone-500">Last updated: August 2026</p>

            <h3 className="font-bold text-sm text-stone-800 pt-2">1. User Conduct & Content Standards</h3>
            <p>
            ...
            <h3 className="font-bold text-sm text-stone-800 pt-2">2. Collaboration & Permissions</h3>
            <p>
        ...
        {activeTab === 'cookies' && (
          <div className="space-y-4">
            <h2 className="font-serif text-2xl font-bold text-stone-900">Cookie & Local Storage Policy</h2>
            <p className="text-stone-500">Last updated: August 2026</p>

            <h3 className="font-bold text-sm text-stone-800 pt-2">1. Essential Cookies</h3>
            <p>
