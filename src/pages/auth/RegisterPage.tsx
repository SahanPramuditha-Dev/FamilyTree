...
import { Trees, Mail, Lock, User, ArrowRight, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-3xl shadow-elevated border border-stone-200/80 max-w-md w-full p-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="font-serif text-2xl font-bold text-stone-900">Create Your Free Tree</h2>
          <p className="text-xs text-stone-500">Begin chronicling your family heritage across generations</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] uppercase font-bold text-stone-400">or register with email</span>
          <div className="flex-1 h-px bg-stone-200" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start gap-2 text-xs text-stone-600">
            ...
            />
            <span>
              I accept the <Link to="/terms" className="text-forest-700 underline">Terms of Service</Link> and agree to the <Link to="/privacy-policy" className="text-forest-700 underline">Privacy Policy</Link>.
            </span>
          </div>
